import {
  ...
  import NouvelleFonction from "./NouvelleFonction";
      ...
      return (
        <div className="flex flex-col px-40  mt-10  ml-16">
          <div className="flex flex-row w-full mb-6">
            <div className="flex flex-row w-3/5  ">
              ...
              <div className="w-2/5 flex justify-end">
                <div
                  ...
                  className="w-full  cursor-pointer flex flex-row justify-between items-center text-gray-500  text-xs py-2 font-medium px-9 rounded bg-white mr-6"
                >
            ...
            <div className="w-2/5 text-xs font-semibold text-sky-700   flex justify-end">
              <button
                data-bs-toggle="modal"
                data-bs-target="#exampleModal"
                className=" px-6 bg-green-300 rounded-xl"
              >
          ...
          <h4 className="rounded-t font-semibold text-white bg-sky-700 px-12  py-3">
            Fiche de fonction
          </h4>
