      ...
      <div className="relative">
        ...
        >
          <div className="w-full  h-full flex flex-col text-gray-500  text-sm  font-medium ">
            <div className="flex w-3/4 mb-3  justify-between text-blue-800 ">
                ...
                <div key={index} className="flex flex-col w-full ">
                  ...
                  >
                    ...
                    <div
                      ...
                      className={`
                        w-11/12 flex items-center px-2 mb-2 text-xs  border-gray-300 rounded rounded-lg  ${
                          this.state.hidden[index] ? "" : "border"
                        } justify-between`}
                    >
                      <div>
                        <span className="mr-9 font-bold  text-blue-700">
                          Date création
                        </span>
                        <span>15/06/2023</span>
                      </div>
                    ...
                    <div
                      className="
                        w-6/12 flex px-2 mb-2 text-gray-700 text-xs font-bold rounded rounded-lg py-2 justify-between"
                    >
                      <button>
                        {" "}
                        <FontAwesomeIcon
        ...
        >
          <div className="w-full flex items-center justify-between mb-2 rounded cursor-pointer hover:text-blue-800 hover:bg-slate-100 p-2">
            <span className="text-sm font-semibold">Impression rapide</span>
            <FontAwesomeIcon className="text-blue-800" icon={faPrint} />
          </div>
          <div className="w-full flex items-center justify-between mb-2 rounded cursor-pointer hover:bg-slate-100 hover:text-blue-800 p-2">
            <span className="text-sm font-semibold">PDF</span>
            <FontAwesomeIcon className="text-blue-800" icon={faFilePdf} />
          </div>
          <div className="w-full flex items-center justify-between  rounded cursor-pointer hover:text-blue-800 hover:bg-slate-100 p-2">
            <span className="text-sm font-semibold">Excel</span>
            <FontAwesomeIcon className="text-blue-800" icon={faFileExcel} />
          </div>
        </div>
        <div className="flex justify-end mt-2 mr-1">
          <div className="bg-blue-800 w-7 h-7 rounded-full flex items-center justify-center">
            <FontAwesomeIcon
              onClick={() => {
                this.setState({
